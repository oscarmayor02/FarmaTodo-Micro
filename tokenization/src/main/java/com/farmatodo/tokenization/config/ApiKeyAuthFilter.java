...
/**
 * Filtro sencillo de API Key: valida header X-API-KEY en cada request.
 * Excluyo /ping y Swagger para facilitar la exploración.
 */
@Component
public class ApiKeyAuthFilter extends OncePerRequestFilter {

    @Value("${app.security.api-key}")// Leo la API key de configuración
    private String configuredKey;

    // Paths públicos sin API key
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        // Si empieza por un path permitido, no filtro
